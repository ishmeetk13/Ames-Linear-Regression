...
It is a project for predicting house prices using Linear Regression. I used the Ames Housing Sales dataset to see how adding categorical features (like neighborhoods and house styles) affects the model's accuracy.
